...
export default function StatusBadge({
  ...
  const colors: Record<string, { bg: string; border: string; text: string }> = {
    blue: { bg: "bg-gradient-to-r from-blue-50 to-cyan-50", border: "border-blue-200", text: "text-blue-700" },
    teal: { bg: "bg-gradient-to-r from-teal-50 to-cyan-50", border: "border-teal-200", text: "text-teal-700" },
  };
  ...
  return (
    <div class="text-center animate-slide-down py-4">
      <div class={`inline-flex items-center gap-2 px-4 py-2 ${theme.bg} border-2 ${theme.border} rounded-full shadow-sm`}>
